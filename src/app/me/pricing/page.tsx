      ...
      <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-10">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-[#5b5349]">
            免费用户可先体验 5 次。正式使用可开通 Pro 或 Ultra；额度不够时，再购买独立加量包。
          </p>
        </div>
              ...
              >
                <div className="grid gap-5 p-8">
                  ...
                  <div className="flex items-end gap-2">
                    <span className="text-5xl font-semibold tracking-[-0.06em] text-[#101828]">{plan.price}</span>
                    <span className="pb-1 text-base text-[#6f675c]">{plan.detail}</span>
                  </div>
                  <a href="#contact" className="brand-button w-full justify-center">
                    {plan.buttonLabel}
                  </a>
                </div>
        ...
        >
          <div className="grid gap-4">
            ...
            <p className="text-base leading-8 text-[#5b5349]">
              扫码添加雅小满客服微信，备注你要购买的套餐：Pro、Ultra 或加量包。付款完成后，会在后台手动为你的账号开通对应额度。
            </p>
            <div className="grid gap-3 rounded-[24px] bg-[#f7f9fc] p-5 text-sm leading-7 text-[#344054]">
              <p>Pro：39 元 / 30天 / 500 次</p>
              <p>Ultra：79 元 / 30天 / 1500 次</p>
              <p>加量包：39 元 / 30天 / 500 次，仅 Pro / Ultra 用户可购买</p>
